...
[local coordinates and placement](local-coordinates.md). For exact signatures and
limits, see [originPoint](api/origin-point.md), [originVertex](api/origin-vertex.md),
[originOffset](api/origin-offset.md), [originCenter](api/origin-center.md),
[model.rotate](api/model-rotate.md) and [scaled](api/scaled.md).
