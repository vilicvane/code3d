...
Independent [Frame](frame.md) values also support `.relate(build)`, returning
a new frame with the same callback-identity and solve-order rules. Frames
contribute references without finite geometry.
