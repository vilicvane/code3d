...
const exampleSeconds: Record<string, number> = {
  ...
  'npm/model.ts': 208,
  'packages/layout/grid.ts': 63,
  'packages/layout/linear.ts': 57,
  'packages/layout/radial.ts': 58,
  'packages/layout/ventilation.ts': 54,
  'packages/layout/flex.ts': 57,
  'packages/layout/flex-space.ts': 50,
  'packages/layout/flex-wrap.ts': 51,
  'packages/layout/fill-grid.ts': 49,
  'packages/layout/grille.ts': 50,
