import {sketch, loft, point, box} from '@code3d/core';
...
// Loft takes one face per section. A single hole corresponds unambiguously;
// differing hole counts or multiple unpaired holes produce a diagnostic.
export const inlet = sketch([
  ['point', 1, [0, 0]],
  ['circle', 2, [1, 12]],
  ['circle', 3, [1, 8]],
]);
export const outlet = sketch([
  ['point', 1, [0, 0]],
  ['circle', 2, [1, 8]],
  ['circle', 3, [1, 5]],
]);
export const duct = loft([
  inlet.face(),
  outlet.face().relate(face => face.on(point([0, 30, 0]).up)),
]);
