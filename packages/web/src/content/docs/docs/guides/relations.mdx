...
<ModelExample id="relation-preview" />
...
<ModelExample id="geometric-alignment" />
...
<p>
  <a href={sitePath('examples/relation-preview/')}>
...
its paint; the marker groups still show which side is selected.
