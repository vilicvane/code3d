...
actual shape, with arrows at positive endpoints or stable points on closed
curves. Axes use one positive arrow. A solid source arrow and a larger outline
target arrow distinguish coincident directions. Unsupported geometry,
