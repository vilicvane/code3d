...
`originPoint()` and `originOffset()`; their default origin comes from the center
of their direct members’ origin bounds. See [group origins](../../concepts/local-coordinates/#group-origins)
for direct assembly and instance selection. See the [API reference](../../reference/core/#origins-and-rotation)
