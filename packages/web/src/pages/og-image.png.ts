...
const source = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <g font-family="Arial,sans-serif">
    ...
    <text x="62" y="250" fill="#ecefe5" font-size="70" font-weight="600">Code and geometry,</text>
    <text x="62" y="345" fill="#a3ad95" font-size="60">connected.</text>
    <text x="64" y="465" fill="#d8ff3e" font-size="21" letter-spacing="3">A SOLID MODELER FOR PEOPLE WHO CODE</text>
